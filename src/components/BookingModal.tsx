...
export default function BookingModal({ open, onClose, events, preselectedEventId }: Props) {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <label className="flex flex-col gap-2">
                  ...
                  <select
                    ...
                    className="border-2 border-[#1C1712] bg-[#F5F0E6] px-4 py-3 focus:outline-none focus:border-[#B8451D]"
                  >
                    <option value="">Any upcoming night</option>
                    {events.map((ev) => (
              ...
              <button
                ...
                className="btn-rust mt-2 py-4 font-display text-xl disabled:opacity-60"
              >
